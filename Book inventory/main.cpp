...
void bookInventory::user_Interface()
{
	system("cls");
	cout << "\n\n\t\t\t\tCONTROL PANEL";
	cout << "\n\n1. ADD BOOK";
...
void bookInventory::display_Book()
{
	system("cls");
	fstream file;
	int no_copy;
...
void bookInventory::update_book()
{
	system("cls");
	fstream file, file1;
